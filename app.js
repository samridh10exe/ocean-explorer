const zoneData = [
  {
    ...
    particleCount: 34,
    pollutionTypes: ["bottle", "bag", "tire"],
  ...
  },
  {
    ...
    particleType: "bio",
    particleCount: 36,
    pollutionTypes: ["bag", "tire", "bottle"],
...
const creatureData = [
  ...
  },
  {
    ...
    facts: [
      ...
      "Its eyes can appear bright red, making the head look eerie in deep-sea light.",
    ],
  ...
  {
    id: "abyssal_snailfish",
    zone: "abyssal",
    name: "Abyssal Snailfish",
    rarity: "Rare",
    depthRange: "4000–6000 m",
    zoneLabel: "Abyssal Pressure Fish",
    facts: [
      "Abyssal snailfish live on the open deep seafloor rather than the trench bottom.",
      "Their soft, pale bodies save energy in a cold world where food arrives slowly.",
      "They feed on small crustaceans and scavenged particles drifting across abyssal mud.",
    ],
    ...
    bioColor: "var(--bio-blue)",
    points: 7,
    position: { top: "32%", left: "48%", width: "clamp(8rem, 11vw, 10rem)" },
  },
  {
    id: "giant_tube_worm",
    zone: "hadal",
  ...
  },
  {
    ...
    facts: [
      "Hadal snailfish live inside ocean trenches under pressure far beyond the abyssal plain.",
      "Their body chemistry uses pressure-protective molecules that keep proteins working.",
      "Scientists have filmed hadal snailfish among the deepest-living fish ever observed.",
    ],
    wrongAnswers: ["Hadal Amphipod", "Sea Angel"],
...
const pollutionPalette = {
  ...
  bag: { main: "#c7c8bd", shade: "#8f948b", line: "#565f58", alpha: 0.66 },
...
const pollutionZoneSettings = {
  sunlight: { initial: 4, respawn: 1250, duration: [13, 17], size: [4.0, 5.2], drift: [-6, 7] },
  twilight: { initial: 3, respawn: 1200, duration: [16, 21], size: [3.7, 4.9], drift: [-7, 6] },
...
function pollutionSvg(type) {
  ...
  const svgs = {
    ...
    bag: `<svg class="trash-illustration trash-bag" viewBox="0 0 64 64" style="${palette}" aria-hidden="true"><path class="trash-fill" d="M15.5 20.5c5.6-2.3 9.3-.7 13.4-.8 5.3-.1 9.8-3 17.9.9 2 12.4 4.4 23.2 7.1 33.6-11 4.1-27.2 4.3-41.7.2 1.3-11.1 2.1-22.1 3.3-33.9Z"/><path class="trash-shade" d="M20.1 28.4c8.4-4 19.1-3.1 28.3 4.6l3.3 18.6c-10.1 3.2-23.6 3.1-35.5.1l3.9-23.3Z"/><path class="trash-line" d="M23.4 21.2c.6-7.4 4.3-11.4 9.1-11.3 4.6.1 7.7 4 8.1 11.6M22.7 38.4c7.3-3 15.3-2.1 23 2.6"/></svg>`,
